...
insert into products (name, defaultPrice, currency, description, categoryId, supplierId) values ('topcare severe sinus congestion', 353.62, 'PEN', 'dolor sit amet consectetuer adipiscing elit proin risus praesent lectus vestibulum quam', 5, 1);
...
insert into products (name, defaultPrice, currency, description, categoryId, supplierId) values ('TIME ZONE', 599.73, 'UAH', 'vestibulum rutrum rutrum neque aenean auctor gravida sem praesent id massa id nisl', 4, 5);
insert into products (name, defaultPrice, currency, description, categoryId, supplierId) values ('Walgreens Sunscreen', 202.0, 'PLN', 'id lobortis convallis tortor risus dapibus augue vel accumsan tellus nisi', 4, 8);
...
insert into products (name, defaultPrice, currency, description, categoryId, supplierId) values ('LBEL NATURAL FINISH MOISTURIZING FOUNDATION SPF 25', 740.7, 'AFN', 'donec posuere metus vitae ipsum aliquam non mauris morbi non lectus aliquam sit amet diam', 8, 7);
...
insert into products (name, defaultPrice, currency, description, categoryId, supplierId) values ('Triple Antibiotic', 93.84, 'NGN', 'nibh quisque id justo sit amet sapien dignissim vestibulum vestibulum ante ipsum primis in faucibus orci luctus et ultrices', 10, 10);
...
insert into products (name, defaultPrice, currency, description, categoryId, supplierId) values ('Mastic Dent Whitening', 764.78, 'KMF', 'ac nulla sed vel enim sit amet nunc viverra dapibus nulla suscipit ligula in lacus curabitur at ipsum', 6, 3);
insert into products (name, defaultPrice, currency, description, categoryId, supplierId) values ('Ibuprofen', 130.57, 'EGP', 'primis in faucibus orci luctus et ultrices posuere cubilia curae mauris viverra diam vitae quam suspendisse potenti nullam porttitor', 10, 1);
...
insert into products (name, defaultPrice, currency, description, categoryId, supplierId) values ('ClomiPHENE Citrate', 520.4, 'RSD', 'sagittis nam congue risus semper porta volutpat quam pede lobortis ligula', 2, 2);
...
insert into products (name, defaultPrice, currency, description, categoryId, supplierId) values ('Xylocaine', 615.95, 'ARS', 'sit amet sem fusce consequat nulla nisl nunc nisl duis bibendum felis sed interdum venenatis turpis', 8, 1);
